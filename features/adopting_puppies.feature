...
#    Then I should see "Thank you for adopting a puppy!"
#
#  Scenario Outline: Adopting one puppy by couple of people
#    When I click the first View Details button
#    And I click the Adopt Me button
#    And I click the Complete the Adoption button
...
#    Then I should see the error message "Name can't be a banana"
...
#    Then I should see the thank you message
  ...
  Scenario: Verify message when adoption is processed
    Given I have a pending adption for "Tom Jones"
